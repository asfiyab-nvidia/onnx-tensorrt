...
Development on the Master branch is for the latest version of [TensorRT 8.2.2.1](https://developer.nvidia.com/nvidia-tensorrt-download) with full-dimensions and dynamic shape support.
...
### Dependencies
 ...
 - [TensorRT 8.2.2.1 open source libaries (master branch)](https://github.com/NVIDIA/TensorRT/)
