...
Development on the `main` branch is for the latest version of [TensorRT 8.5.0.9](https://developer.nvidia.com/nvidia-tensorrt-download) with full-dimensions and dynamic shape support.
...
### Dependencies
 ...
 - [TensorRT 8.5.0.9](https://developer.nvidia.com/tensorrt)
 - [TensorRT 8.5.0.9 open source libaries (main branch)](https://github.com/NVIDIA/TensorRT/)
...
TensorRT 8.5.0.9 supports ONNX release 1.12.0. Install it with:
